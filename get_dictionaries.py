...
def get_hi_and_ec():
    HIWC = {
    'Alfalfa': [None, None, None, 1],
    'Banana': [0.6, 0.76, None, 1],
    'Barley': [None, None, None, 1],
    'Beans': [0.16, 0.33, None, 1],
    'Cassava': [0.6, 0.65, None, 1],
    'Cashew': [0.03, 0.3, None, 1],
    'Chickpea' : [.34, .15, None, 1],
    'Coconut': [0.244, 0.0, None, 1],
    'Coffee': [0.012, 0.88, None, 1],
    'Cotton': [0.13, 0.2, None, 1],
    'Eucalyptus':[0.5, 0.50, None, 1],
    'Grapes':[0.22, 0.75, None, 1],
    'Grass':[0.45, 0.60, None, 1],
    'Lucerne':[0.6, None, None, 1],
    'Maize - Rainfed': [0.32, 0.26, None, 1.8],
    'Maize - Irrigated': [0.39, 0.26, None, 1.8],
    'Mango': [0.14, 0.84, None, 1],
    'Olives': [0.012, 0.20, None, 1],
    'Onions': [0.55, 0.85, None, 1],
    'Oranges': [0.22, 0.85, None, 1],
    'Palm Oil': [0.185, 0.1, None, 1],
    'Pineapple': [None, None, None, 1],
    'Potato': [0.8, 0.80, None, 1],
    'Rice - Rainfed': [0.33, 0.16, None, 1],
    'Rice - Irrigated': [0.42, 0.16, None, 1],
    'Rubber': [0.013, 0.63, None, 1],
    'Sorghum': [0.25, None, None, 1.8],
    'Soybean': [None, None, None, 1],
    'Sugarbeet': [0.6, 0.80, None, 1],
    'Sugar cane': [0.69, 0.65, None, 1.8],
    'Tapioca': [None, None, None, 1],
    'Tea': [0.12, 0.50, None, 1],
    'Wheat': [0.37, 0.15, None, 1],
    'Fodder': [0.45,0.6, None, 1],
    'Peanut':[0.03, 0.3, None, 1],
    'Almond':[0.03, 0.3, None, 1],
    'Pepper':[0.1, 0.5, None, 1],
    'Melon':[0.8, 0.6, None, 1]
        }
